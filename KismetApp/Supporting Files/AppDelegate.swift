...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if let _ = usersession.getCurrentUser() {
            ...
            let kismetTabBarController = storyboard.instantiateViewController(withIdentifier: "KismetTabBarController") as! KismetTabBarController
            window?.rootViewController = kismetTabBarController
        } else {
